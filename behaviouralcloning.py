...
Original file is located at
    https://colab.research.google.com/drive/18_IwgQlRpZZ-XgswJQ7LS0x3NktUI474
"""
...
#balancing data , as biased model
num_bins = 25
samples_per_bin = 400
...
x_train_gen_img = Image.fromarray((x_train_gen[0] * 255).astype('uint8'))
x_valid_gen_img = Image.fromarray((x_valid_gen[0] * 255).astype('uint8'))
